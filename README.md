...
- **POST** `/visiteurs`
  ...
  - Réponse: `{ success, message, data? }` où `message` vaut “Insertion réussie.” ou “Insertion échouée …”
...
- **PATCH** `/visiteurs/:numeroVisiteur`
  ...
  - Réponse: `{ success, message, data? }` où `message` vaut “Modification réussie.” ou “Modification échouée …”

- **DELETE** `/visiteurs/:numeroVisiteur`
  - Réponse: `{ success, message }` où `message` vaut “Suppression réussie.” ou “Suppression échouée …”
